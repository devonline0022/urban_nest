...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<solidus_backend>.freeze, ["= 3.4.6"])
    s.add_runtime_dependency(%q<solidus_core>.freeze, ["= 3.4.6"])
    s.add_runtime_dependency(%q<solidus_sample>.freeze, ["= 3.4.6"])
    s.add_runtime_dependency(%q<solidus_frontend>.freeze, ["~> 3.4.0.dev"])
  else
    s.add_dependency(%q<solidus_api>.freeze, ["= 3.4.6"])
    s.add_dependency(%q<solidus_backend>.freeze, ["= 3.4.6"])
    s.add_dependency(%q<solidus_core>.freeze, ["= 3.4.6"])
    s.add_dependency(%q<solidus_sample>.freeze, ["= 3.4.6"])
    s.add_dependency(%q<solidus_frontend>.freeze, ["~> 3.4.0.dev"])
  end
end
